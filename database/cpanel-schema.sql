-- Furom Database Schema for cPanel Hosting
-- Version 1.0 - cPanel Compatible

SET SQL_MODE = "NO_AUTO_VALUE_ON_ZERO";
START TRANSACTION;
SET time_zone = "+00:00";

-- NOTE: Database must be created first through cPanel MySQL Databases section
-- Then select that database in phpMyAdmin before importing this file
