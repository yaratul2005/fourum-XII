...
-- Insert default Unknown category
INSERT INTO `categories` (`id`, `name`, `description`, `color`, `icon`, `created_by`, `status`, `post_count`) 
VALUES (0, 'Unknown', 'Default category for uncategorized posts', '#6c757d', 'question-circle', NULL, 'active', 0);
...
('site_name', 'Furom'),
('site_description', 'Futuristic Forum Platform'),
('allow_registration', '1'),
('require_email_verification', '1'),
('kyc_required_for_categories', '0'),
('default_post_category', '0');
